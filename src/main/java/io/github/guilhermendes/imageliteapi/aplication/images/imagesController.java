...
public class imagesController {
    ...
    public ResponseEntity save(
        ...
        log.info("Imagem recebida: name:{}, size:{}, file{}", file.getOriginalFilename(), file.getSize() );

        Image image = mapper.mapToImage(file, name, tags);
        Image savedImage = service.save(image);
        URI imagemUri = buildImageURL(savedImage);

        return ResponseEntity.created(imagemUri).build();
    }
